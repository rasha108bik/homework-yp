...
namespace ASTImpl {
    ...
    public:
        ...
        virtual double Evaluate(const CellFunc &cell_func) const = 0;
    ...
    namespace {
        ...
        public:
            ...
            double Evaluate(const CellFunc &cell_func) const override {
                auto lhs_value = lhs_->Evaluate(cell_func);
                auto rhs_value = rhs_->Evaluate(cell_func);
        ...
        public:
            ...
            double Evaluate(const CellFunc &cell_func) const override {
                auto operand_value = operand_->Evaluate(cell_func);
                switch (type_) {
                    case UnaryPlus:
        ...
        public:
            ...
            double Evaluate(const CellFunc &) const override {
                return value_;
            }
...
double FormulaAST::Execute(const CellFunc &cell_func) const {
